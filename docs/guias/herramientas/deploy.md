...
| Cuando bajo mi módulo servidor tengo que esperar 30 segundos porque sino no me andan los sockets. |                                                  Es una medida de seguridad de Linux para que no puedan robar paquetes enviados a tu servidor.[^5]                                                  |                                                                            Configurar [setsockopt](https://stackoverflow.com/a/24194999) para marcar a la IP y el puerto como reusables ignorando el riesgo de seguridad que conlleva; o ir tanteando con [`lsof`](/guias/consola/bash.html#lsof) para saber si el puerto ya fue liberado o no sin tener que volver a levantar el módulo.                                                                            |
