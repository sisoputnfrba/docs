...
Esta guía es un resumen bastante reducido y minimalista de la guía Beej, donde obviamos muchos conceptos de redes que no interesan para esta materia. Para los interesados, o aquellos que deseen ahondar más en busca de distintas formas de implementación, dejamos el link (únicamente en inglés) . También hay una traducción casera de la cátedra, por lo que si ven alguna oportunidad de mejora en redacción o traducción estamos abiertos a escucharlos.
